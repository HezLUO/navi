# Frozen Legacy Navi Trigger Fixture

This file preserves recognized pre-current managed-block bytes for active migration tests. It is test input, not product guidance or an authoritative policy source.
